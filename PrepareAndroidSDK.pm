...
our $ndks =
    ...
    "r18b" =>
        {
        "windows" => "android-ndk-r18b-windows-x86_64.zip",
        "macosx"  => "android-ndk-r18b-darwin-x86_64.zip",
        "linux"   => "android-ndk-r18b-linux-x86_64.zip",
        },
    };
...
sub PrepareNDK
{
    ...
    if ($ndk =~ m/r13/ or $ndk =~ m/r16/ or $ndk =~ m/r18/)
    {
